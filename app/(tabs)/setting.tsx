      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <SettingsSection title="Cài đặt Chung">
          <View className="overflow-hidden rounded-lg">
            <SettingsItem
              icon={<User size={24} color={colors.greenPrimary} />}
            ...
            <SettingsItem
              ...
              icon={<Shield size={24} color={colors.greenPrimary} />}
              onPress={() => {
                navigate("/privacy-security");
              }}
            />
            <SettingsItem
              icon={<Bell size={24} color={colors.greenPrimary} />}
              title="Thông báo"
            ...
            <SettingsItem
              icon={<Smartphone size={24} color={colors.greenPrimary} />}
        ...
        <SettingsSection title="Giao diện">
          <View className="overflow-hidden rounded-lg">
            <SettingsItem
              icon={<Moon size={24} color={colors.greenPrimary} />}
              title="Chế độ tối"
            ...
            />
            <SettingsItem
              icon={<Palette size={24} color={colors.greenPrimary} />}
              title="Chủ đề"
        ...
        <SettingsSection title="Hỗ trợ">
          <View className="overflow-hidden rounded-lg">
            <SettingsItem
              icon={<HelpCircle size={24} color={colors.greenPrimary} />}
